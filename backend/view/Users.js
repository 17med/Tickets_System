...
router.post("/api/user/state",AuthMiddleware.isadmin,UserMiddleware.Transformstate,UserController.Transformstate)
router.post("/api/user/delete",AuthMiddleware.isadmin,UserMiddleware.deleteuser,UserController.deleteUser)
